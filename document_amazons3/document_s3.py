...
class DocumentAmazonS3(orm.Model):
    ...
    def _s3_connection_and_bucket(self, location):
        ...
        # loc_parse is supposed to be bucket name in this case
...
#         s3_conn = boto.connect_s3(access_key_id, secret_key)
        s3_conn = boto3.resource('s3',aws_access_key_id="AKIAIQ53TAHKWL4Z6SRA",
                                      aws_secret_access_key="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")
